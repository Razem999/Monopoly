...
/**The gameInterface.TextGameInterface consists of text-based responses that the Player will receive,
...
public class TextGameInterface implements GameInterfaceI {
    ...
    /**Override function processSale in gameInterface.GameInterfaceI and checks to see if the Player is going to purchase
     * the property
    ...
    /**Overrides function notifyPlayerDeclinedPurchase in gameInterface.GameInterfaceI and notifies Players
    ...
    /**Overrides function notifyPlayerPurchaseConfirm in gameInterface.GameInterfaceI and notifies Players
    ...
    /**Overrides function notifyRentPayment in gameInterface.GameInterfaceI and notifies Players
    ...
    /**Overrides function notifyBankruptcy in gameInterface.GameInterfaceI and notifies Players
    ...
    /**Overrides function notifyRoll in gameInterface.GameInterfaceI and notifies Players
    ...
    /**Overrides function notifyPassGo in gameInterface.GameInterfaceI and notifies Players
    ...
    /**Overrides function notifyPlayerMovement in gameInterface.GameInterfaceI and notifies Players
    ...
    /**Overrides function notifyCannotRoll in gameInterface.GameInterfaceI and notifies Players
    ...
    /**Overrides function notifyCannotBuyTileKind in gameInterface.GameInterfaceI and notifies Players
    ...
    /**Overrides function notifyCannotBuyAlreadyOwned in gameInterface.GameInterfaceI and notifies Players
    ...
    /**Overrides function notifyCannotBuyTileBalanceReasons in gameInterface.GameInterfaceI and notifies Players
    ...
    /**Overrides function notifyPlayerOwnsThis in gameInterface.GameInterfaceI and notifies Players
    ...
    /**Overrides function notifyPlayerSentToJail in gameInterface.GameInterfaceI and notifies Players
    ...
    /**Overrides function notifyPlayerLeftJail in gameInterface.GameInterfaceI and notifies Players
    ...
    /**Overrides function notifyPlayerStayJail in gameInterface.GameInterfaceI and notifies Players
    ...
    /**Overrides function notifyFreeParkingDeposit in gameInterface.GameInterfaceI and notifies Players
